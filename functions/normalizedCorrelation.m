function CC = normalizedCorrelation(s1, s2, Fs, SmoothMethod, Wn, K, isWhitend)
%
...
if isWhitend == 0
    ...
    switch SmoothMethod
        ...
        case 'taper'
            ...
            CC.c2 = fftshift( ifft( SpectralDomainCorr./sqrt(ns1'.*ns2') ) ).*tukeywin(nfft,0.1)';
            
            % get time domain normalized correlation by virtual source station
            CC.c3 = fftshift( ifft( SpectralDomainCorr./(ns1'.^2) ) );
